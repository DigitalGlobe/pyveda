# -*- coding: utf-8 -*-
#
# pyveda documentation build configuration file
#
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.autosectionlabel', 'nbsphinx']
