...
class VCFetchTest(unittest.TestCase):
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch.yaml',
        filter_headers=['authorization'])
    def setUp(self):
        self.vc = pv.from_id(VC_ID)

    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_fetch_index.yaml',
        filter_headers=['authorization'])
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_fetch_slice.yaml',
        filter_headers=['authorization'])
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_fetch_sample_id.yaml',
        filter_headers=['authorization'])
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_ids.yaml',
        filter_headers=['authorization'])
    def test_ids(self):
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_ids_urls.yaml',
        filter_headers=['authorization'])
    ...
    @my_vcr.use_cassette(
        'tests/unit/cassettes/test_vcfetch_getatr.yaml',
        filter_headers=['authorization'])
